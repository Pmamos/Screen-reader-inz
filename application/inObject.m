...
if(size_b(1))
    ...
    %sprawdzamy czy nie jesteśmy zbyt blisko krawędzi
    %określamy co w pozostałych przypadkach
    if(pos(1) < center)
        point(1) = pos(1);
    ...
    komunikat = [];
    %przechodzimy po kolejnych obiektach
    for i = 1:size_b(1)

        %bo kursor zawsze jest na środku obrazka
